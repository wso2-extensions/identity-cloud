...
package org.wso2.carbon.identity.cloud.listener.claim.onprem.security;
...
/**
 * JWT Token Generator to pass on premise agent interceptor.
 */
public class DefaultJWTGenerator implements SecurityTokenBuilder {
    ...
    public DefaultJWTGenerator() throws ClaimManagerListenerException {
        signatureAlgorithm = mapSignatureAlgorithm(DEFAULT_SIGNING_ALGORITHM);
    }

    protected JWSAlgorithm mapSignatureAlgorithm(String signatureAlgorithm) throws ClaimManagerListenerException {
        ...
        throw new ClaimManagerListenerException("Unsupported Signature Algorithm in identity.xml");
    }

    @Override
    public String buildSecurityToken(Key privateKey) throws ClaimManagerListenerException {
    ...
    protected String signJWTWithRSA(JWTClaimsSet jwtClaimsSet, Key privateKey) throws ClaimManagerListenerException {
        try {
            ...
            throw new ClaimManagerListenerException("Error occurred while signing JWT", e);
        }
    }
