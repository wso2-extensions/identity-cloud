...
$JAVA_HOME/bin/java -Dtransports.netty.conf="$CARBON_HOME"/conf/netty-transports.yml -classpath "$CARBON_CLASSPATH" org.wso2.carbon.identity.agent.onprem.userstore.Application $*
